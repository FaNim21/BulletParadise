...
public class ExpandableAttributeDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        //new Rect(fieldRect.x - 15, fieldRect.y, fieldRect.width, fieldRect.height)
        property.isExpanded = EditorGUI.Foldout(new Rect(fieldRect.x - 15, fieldRect.y, fieldRect.width, fieldRect.height), property.isExpanded, GUIContent.none, true);
