...
{
    public class ProjectileWaveBehaviour : ProjectileBehavior
    {
        public ProjectileWaveBehaviour(ProjectileBehaviorData data, Rigidbody2D rb, Vector2 velocity) : base(data, rb, velocity) { }
